...
public class RecruiterFullProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recruiter_full_profile);
        ...
        rectomain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mainpage = new Intent(RecruiterFullProfile.this, RecruiterActivity.class);
