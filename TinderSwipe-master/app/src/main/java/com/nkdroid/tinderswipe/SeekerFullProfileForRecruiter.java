...
public class SeekerFullProfileForRecruiter extends AppCompatActivity {
    ArrayList namesofseekers = new ArrayList();
    int z = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seeker_full_profile_for_recruiter);
        Intent intenti = getIntent();
        final String seekername = intenti.getStringExtra("extra");

        getandsetData(seekername);

        //        Setting round image
        ImageView profilePicture = (ImageView)findViewById(R.id.recbacktomain);
        ...
        ImageView rectomain = (ImageView) findViewById(R.id.recbacktomain);
        rectomain.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent mainpage = new Intent(SeekerFullProfileForRecruiter.this, RecruiterActivity.class);
...
/*loc*/
                String splace = (String) dataSnapshot.child("Location").getValue();
/* desc */
                String sbio = (String) dataSnapshot.child("Description").getValue();
/* work1 */
                String sworkex = (String) dataSnapshot.child("Work Experience").child("WE1").child("We1").getValue();
                System.out.println("Work ex = " + sworkex);
/* work2 */
                String sworkexcont1 =  (String.valueOf(dataSnapshot.child("Work Experience").child("WE1").child("We2").getValue()));
                String sworkexcont = "  "+sworkexcont1+" years";
/* ed1 */
                String seducation = (String) dataSnapshot.child("Education").child("ED1").child("Ed1").getValue();
/* ed2 */
                String seducationcont = (String) dataSnapshot.child("Education").child("ED1").child("Ed2").getValue();
/* ro1 */
                String srole1 = (String) dataSnapshot.child("Roles").child("R1").getValue();
/* ro2 */
                String srole2 = (String) dataSnapshot.child("Roles").child("R2").getValue();
/* ro3 */
                String srole3 = (String) dataSnapshot.child("Roles").child("R3").getValue();
/* goal */
                String sgoal = (String) dataSnapshot.child("My goals").getValue();
/* skill1 */
                String sskill1 = (String) dataSnapshot.child("Skillset").child("Sk1").getValue();
                System.out.println("Skill1" + sskill1);
/* skill2 */
                String sskill2 = (String) dataSnapshot.child("Skillset").child("Sk2").getValue();
/* skill3 */
                String sskill3 = (String) dataSnapshot.child("Skillset").child("Sk3").getValue();
/* skill4 */
                String sskill4 = (String) dataSnapshot.child("Skillset").child("Sk4").getValue();
/* skill5 */
                String sskill5 = (String) dataSnapshot.child("Skillset").child("Sk5").getValue();
/* skill6 */
                String sskill6 = (String) dataSnapshot.child("Skillset").child("Sk6").getValue();
/* skill7 */
                String sskill7 = (String) dataSnapshot.child("Skillset").child("Sk7").getValue();
/* lang1 */
                String slang1 = (String) dataSnapshot.child("Language").child("Lg1").getValue();
/* lang2 */
                String slang2 = (String) dataSnapshot.child("Language").child("Lg2").getValue();
/* lang3 */
                String slang3 = (String) dataSnapshot.child("Language").child("Lg3").getValue();
/* power1 */
                String spower1 = (String) dataSnapshot.child("3 superpowers").child("Sp1").getValue();
/* power2 */
                String spower2 = (String) dataSnapshot.child("3 superpowers").child("Sp2").getValue();
/* power3 */
                String spower3 = (String) dataSnapshot.child("3 superpowers").child("Sp3").getValue();
/* des1 */
                String sdescribe1 = (String) dataSnapshot.child("5 words that describe me").child("W1").getValue();
/* des2 */
                String sdescribe2 = (String) dataSnapshot.child("5 words that describe me").child("W2").getValue();
/* des3 */
                String sdescribe3 = (String) dataSnapshot.child("5 words that describe me").child("W3").getValue();
/* des4 */
                String sdescribe4 = (String) dataSnapshot.child("5 words that describe me").child("W4").getValue();
/* des5 */
                String sdescribe5 = (String) dataSnapshot.child("5 words that describe me").child("W5").getValue();
...
/* salc */
                String spsal = (String) dataSnapshot.child("Previous Salary").getValue();
/* salex */
                String sesal = (String) dataSnapshot.child("Expected Salary").getValue();
